...
> iteraciones previas pero NO existe como backend en Agno 2.8.3 (no hay módulo
...
> **Nota**: agno 2.8.3 expone 18 embedders (no 17). `OpenAILikeEmbedder` y
...
> argumento `password=` del `PDFReader` (BasePDFReader). Agno 2.8.3 expone
