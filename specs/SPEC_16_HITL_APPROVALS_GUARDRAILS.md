...
# Agno v2.6.22 members (lowercase): pending / running / completed / paused /
# cancelled / error.
...
El record de approval se persiste en la tabla `approvals`, cuyo schema es **propio de Agno** (`agno/db/schemas/approval.py`). yaml-agno NO redefine esta tabla; la usa tal cual. Schema real (Agno v2.6.22):
