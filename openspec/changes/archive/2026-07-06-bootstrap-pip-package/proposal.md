...
reciben cada uno un `__init__.py` **vacío** — no `.gitkeep` — porque (a) son
...
| `src/yaml_agno/{21 subdirs}/__init__.py` | New | 21 archivos vacíos (api, factories, models, di, persistence, memory, workflows, tools, knowledge, media, hitil, guardrails, skills, culture, reasoning, evals, scheduler, config, tracing, templates, runtime). |
